...
type ParseOutboundsRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	ConfigPath    string                 `protobuf:"bytes,1,opt,name=config_path,json=configPath,proto3" json:"config_path,omitempty"`
...
func (x *ParseOutboundsRequest) Reset() {
	*x = ParseOutboundsRequest{}
	mi := &file_v2_hcore_hcore_proto_msgTypes[22]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *ParseOutboundsRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ParseOutboundsRequest) ProtoMessage() {}

func (x *ParseOutboundsRequest) ProtoReflect() protoreflect.Message {
	mi := &file_v2_hcore_hcore_proto_msgTypes[22]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ParseOutboundsRequest.ProtoReflect.Descriptor instead.
func (*ParseOutboundsRequest) Descriptor() ([]byte, []int) {
	return file_v2_hcore_hcore_proto_rawDescGZIP(), []int{22}
}

func (x *ParseOutboundsRequest) GetConfigPath() string {
	if x != nil {
		return x.ConfigPath
	}
	return ""
...
func (x *ParseOutboundsRequest) GetConfigContent() string {
	if x != nil {
		return x.ConfigContent
	}
	return ""
...
const file_v2_hcore_hcore_proto_rawDesc = "" +
	...
	"\n" +
	"is_enabled\x18\x01 \x01(\bR\tisEnabled\"_\n" +
	"\x15ParseOutboundsRequest\x12\x1f\n" +
	"\vconfig_path\x18\x01 \x01(\tR\n" +
	"configPath\x12%\n" +
	"\x0econfig_content\x18\x02 \x01(\tR\rconfigContent\"\xa1\x01\n" +
	"\n" +
	"LogMessage\x12%\n" +
...
var file_v2_hcore_hcore_proto_goTypes = []any{
	...
	(*ParseOutboundsRequest)(nil),        // 27: hcore.ParseOutboundsRequest
