...
const (
	...
	Core_ParseOutbounds_FullMethodName        = "/hcore.Core/ParseOutbounds"
)
...
type CoreClient interface {
	...
	ParseOutbounds(ctx context.Context, in *ParseOutboundsRequest, opts ...grpc.CallOption) (*OutboundGroupList, error)
}
...
func (c *coreClient) ParseOutbounds(ctx context.Context, in *ParseOutboundsRequest, opts ...grpc.CallOption) (*OutboundGroupList, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(OutboundGroupList)
	err := c.cc.Invoke(ctx, Core_ParseOutbounds_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type CoreServer interface {
	...
	ParseOutbounds(context.Context, *ParseOutboundsRequest) (*OutboundGroupList, error)
...
func (UnimplementedCoreServer) ParseOutbounds(context.Context, *ParseOutboundsRequest) (*OutboundGroupList, error) {
	return nil, status.Error(codes.Unimplemented, "method ParseOutbounds not implemented")
}
...
func _Core_ParseOutbounds_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ParseOutboundsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CoreServer).ParseOutbounds(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Core_ParseOutbounds_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CoreServer).ParseOutbounds(ctx, req.(*ParseOutboundsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Core_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "ParseOutbounds",
			Handler:    _Core_ParseOutbounds_Handler,
		},
	},
